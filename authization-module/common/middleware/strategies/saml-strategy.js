...
const
    ...
    SamlStrategy = new (require('passport-saml').Strategy)({
        ...
        user? done(null,user): done(null,await passportUtils.createUser(profile.nameID,'saml',profile['http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress'],null))
    })
