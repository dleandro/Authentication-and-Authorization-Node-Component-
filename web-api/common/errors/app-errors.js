...
module.exports = {
    errorExecutingQuery: new CustomError({
    ...
    noResponseFound: new CustomError({
        title: "No Value found",
        detail: "The response given from the database was empty, either the table was empty or the query didn't output a value",
        status: 404
    }),
    noListFound: new CustomError({
        title: "No List found",
