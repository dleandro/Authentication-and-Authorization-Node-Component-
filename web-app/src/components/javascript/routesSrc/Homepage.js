...
export default function Homepage() {
        ...
        return (<div>
                ...
                <ul>
                        ...
                        <li className="has-line-data" data-line-start={5} data-line-end={7}>Construção de uma aplicação mobile que procure a implementação de um sistema
                                de hierarquiade utilizadores</li>
                </ul>
                <p className="has-line-data" data-line-start={7} data-line-end={8}>
                        Este módulo providência os meios para uma gestão segura e correta de utilizadores para os propósitos de criação tanto de software comercial como
                ...
                <h3 className="code-line" data-line-start={15} data-line-end={16}><a id="GET_httplocalhost8082user_15" />GET
                        <a href="http://localhost:8082/user">http://localhost:8082/user</a></h3>
                ...
                <p className="has-line-data" data-line-start={21} data-line-end={22}>Retorna a lista de todos os objetos
                ...
                <h3 className="code-line" data-line-start={37} data-line-end={38}><a id="POST_httplocalhost8082user_37" />POST <a href="http://localhost:8082/user">
                        http://localhost:8082/user</a></h3>
                <p className="has-line-data" data-line-start={38} data-line-end={39}>Disponível no <strong>backoffice</strong> fornecido.</p>
                <p className="has-line-data" data-line-start={40} data-line-end={41}>Regista um novo
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#user">User</a> na base de dados.</p>
                ...
                <p className="has-line-data" data-line-start={49} data-line-end={50}>Retorna a informação(id e username) relativa ao
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#user">User
                ...
                <h3 className="code-line" data-line-start={56} data-line-end={57}><a id="PUT_httplocalhost8082useridusername_56" />PUT
                ...
                <h3 className="code-line" data-line-start={66} data-line-end={67}><a id="PUT_httplocalhost8082useridpassword_66" />PUT
                ...
                <p className="has-line-data" data-line-start={79} data-line-end={80}>Retorna o conjunto de todos os objetos
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#lists">List</a>.</p>
                ...
                <h3 className="code-line" data-line-start={95} data-line-end={96}><a id="DELETE_httplocalhost8082listid_95" />DELETE <a href="http://localhost:8082/list/:id">
                        http://localhost:8082/list/:id</a></h3>
                <p className="has-line-data" data-line-start={96} data-line-end={97}>Disponível no <strong>backoffice</strong> fornecido.</p>
                <p className="has-line-data" data-line-start={98} data-line-end={99}>Apaga a
                        ...
                        especificada pelo parâmetro id</p>
                <h3 className="code-line" data-line-start={100} data-line-end={101}><a id="GET_httplocalhost8082listactive_100" />GET
                        <a href="http://localhost:8082/list/active">http://localhost:8082/list/active</a></h3>
                ...
                <h3 className="code-line" data-line-start={105} data-line-end={106}><a id="GET_httplocalhost8082listactiveuserid_105" />GET
                ...
                <p className="has-line-data" data-line-start={108} data-line-end={109}>Retorna a coleção de
                        ...
                        </a> ativas relativas ao <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#user">User
                ...
                <p className="has-line-data" data-line-start={118} data-line-end={119}>Adiciona um novo objetos
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#roles">Role</a> na base de dados.</p>
                <pre><code className="has-line-data" data-line-start={120} data-line-end={127}>body: {"{"}{"\n"}{"  "}role: {"{"}{"\n"}{"  "}id: 5,{"\n"}{"  "}role:
                        "admin",{"\n"}{"  "}parent_role: 2{"\n"}{"}"}{"}"}{"\n"}</code></pre>
                <h3 className="code-line" data-line-start={128} data-line-end={129}><a id="DELETE_httplocalhost8082roleid_128" />DELETE <a href="http://localhost:8082/role/:id">
                ...
                <h3 className="code-line" data-line-start={133} data-line-end={134}><a id="GET_httplocalhost8082roleid_133" />GET <a href="http://localhost:8082/role/:id">
                        http://localhost:8082/role/:id</a></h3>
                <p className="has-line-data" data-line-start={134} data-line-end={135}>Disponível no <strong>backoffice</strong> fornecido.</p>
                <p className="has-line-data" data-line-start={136} data-line-end={137}>Retorna o objetos
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#roles">Role</a>
                        especificado por id.</p>
                <h3 className="code-line" data-line-start={138} data-line-end={139}><a id="GET_httplocalhost8082usersroles_138" />GET
                        <a href="http://localhost:8082/users-roles">http://localhost:8082/users-roles</a></h3>
                <p className="has-line-data" data-line-start={139} data-line-end={140}>Disponível no <strong>backoffice</strong> fornecido.</p>
                <p className="has-line-data" data-line-start={141} data-line-end={142}>Retorna o conjunto de todos os objetos
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#users_roles">Users_Roles</a>
                        presentes na base de dados.</p>
                <h3 className="code-line" data-line-start={143} data-line-end={144}><a id="POST_httplocalhost8082usersroles_143" />POST
                        <a href="http://localhost:8082/users-roles">http://localhost:8082/users-roles</a></h3>
                <p className="has-line-data" data-line-start={144} data-line-end={145}>Disponível no <strong>backoffice</strong> fornecido.</p>
                <p className="has-line-data" data-line-start={146} data-line-end={147}>Adiciona um novo objeto
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#users_roles">Users_Roles</a>
                        à base de dados, conectando um <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#roles">
                                Role</a> a um <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#user">User</a></p>
                <pre><code className="has-line-data" data-line-start={148} data-line-end={153}>body: {"{"}{"\n"}{"  "}user: 1,{"\n"}{"  "}role: 2{"\n"}{"}"}{"\n"}</code></pre>
                <h3 className="code-line" data-line-start={154} data-line-end={155}><a id="GET_httplocalhost8082usersrolesactive_154" />GET
                        <a href="http://localhost:8082/users-roles/active">http://localhost:8082/users-roles/active</a></h3>
                <p className="has-line-data" data-line-start={155} data-line-end={156}>Disponível no <strong>backoffice</strong> fornecido.</p>
                <p className="has-line-data" data-line-start={157} data-line-end={158}>Retorna todos os objetos
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#users_roles">Users_Roles</a>
                        que se encontram no estado “active”.</p>
                <h3 className="code-line" data-line-start={159} data-line-end={160}><a id="GET_httplocalhost8082usersrolesactiveuserid_159" />GET
                        <a href="http://localhost:8082/users-roles/active/user/:id">http://localhost:8082/users-roles/active/user/:id</a></h3>
                ...
                <h3 className="code-line" data-line-start={164} data-line-end={165}><a id="GET_httplocalhost8082usersrolesroleiduserid_164" />GET
                        <a href="http://localhost:8082/users-roles/:role-id/user/:id">http://localhost:8082/users-roles/:role-id/user/:id</a></h3>
                ...
                <p className="has-line-data" data-line-start={167} data-line-end={168}>Retorna um
                        <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#roles">Role</a>
                        especificado por role-id do <a href="https://github.com/dleandro/Authentication-and-Authorization-Node-Component-/wiki/Endpoint-Documentation#user">
                                User</a> representado por id.</p>
                <h3 className="code-line" data-line-start={169} data-line-end={170}><a id="GET_httplocalhost8082permission_169" />GET <a href="http://localhost:8082/permission">
                ...
                <p className="has-line-data" data-line-start={172} data-line-end={173}>Retorna o conjunto de todos os objetos
                        ...
                        presentes na base de dados.</p>
                <h3 className="code-line" data-line-start={174} data-line-end={175}><a id="POST_httplocalhost8082permission_174" />POST
                ...
                <pre><code className="has-line-data" data-line-start={179} data-line-end={184}>body: {"{"}{"\n"}{"  "}method: "GET",{"\n"}{"  "}path:
                        "/homepage"{"\n"}{"}"}{"\n"}</code></pre>
                <h3 className="code-line" data-line-start={184} data-line-end={185}><a id="DELETE_httplocalhost8082permission_184" />DELETE
                        <a href="http://localhost:8082/permission">http://localhost:8082/permission</a></h3>
                ...
                de-Component-/wiki/Endpoint-Documentation#permission">Permission</a> correspondente ao representado no body do pedido.</p>
                <pre><code className="has-line-data" data-line-start={189} data-line-end={194}>body: {"{"}{"\n"}{"  "}method: "GET",{"\n"}{"  "}path: "/homepage"
                        {"\n"}{"}"}{"\n"}</code></pre>
                <h3 className="code-line" data-line-start={195} data-line-end={196}><a id="POST_httplocalhost8082rolespermission_195" />POST <a href="http://localhost
