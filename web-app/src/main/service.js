var { configs,users_lists,sessions, users, roles, permissions,  users_roles, lists, roles_permissions, protocols,history} = require('./common/links').webApiLinks;
const DEFAULT_OPTIONS = (met) => { return { method: met, headers: { 'Content-Type': "application/json" } } };
